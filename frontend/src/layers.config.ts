...
export const LAYERS: LayerDef[] = [
  {
    ...
    // «Изумруд → золото» (из дизайн-проекта): зелень дешёвого → золото дорогого.
    // 5-цветная гамма разложена на 6 плавных ступеней.
    colors: ["#0b3d2e", "#126962", "#379374", "#72b26a", "#b7c558", "#f4d35e"],
  },
  {
    id: "rent_sqft",
